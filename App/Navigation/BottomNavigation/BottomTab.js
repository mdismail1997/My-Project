  ...
  return (
    <ImageBackground
      ...
      <View
                ...
                {isLoading ? (
                  ...
                  <>
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        setShowModal(false);
                        props.navigation.navigate('ScheduleLive');
                      }}
                      style={styles.refDivision}>
                      <View
                        style={{
                      ...
                      <Text style={styles.rawTextStyle}>Schedule Live</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                      onPress={() => {
                        setShowModal(false);
        ...
        <TouchableOpacity onPress={() => walletTab()} style={styles.division}>
          <View style={styles.IconStyleChat}>
            <Image
