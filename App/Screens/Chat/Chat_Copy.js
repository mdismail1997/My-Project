...
const Chat = props => {
  ...
  const individualChat = async item => {
    ...
    const celebrityData = {
      celebrity_email: item.email,
    };

    await postApiCall('userfetchchatstatus', celebrityData, {})
      .then(response => {
        Hud.hideHud();
  ...
  const videoCallStatus = async item => {
    ...
    await postApiCall('userfetchcallstatus', celebrityData, {})
      .then(response => {
        Hud.hideHud();
                  ...
                  <Modal visible={showModal} transparent={true}>
                    <View
                      ...
                      <View
                        ...
                        {/* <Image
                            source={require('../../Assets/Icon/close-icon-lg-red.png')}
                            style={{
                              width: '100%',
                              height: '100%',
                              // tintColor: '#E92D87',
