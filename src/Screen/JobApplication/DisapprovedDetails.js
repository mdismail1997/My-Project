...
const DisapprovedDetails = props => {
  ...
  return (
    <Provider>
      <SafeAreaView style={{ backgroundColor: COLORS.WHITE }}>
        {isLoading && <Loader />}
        <Header {...props} title={'Job Disapproved Details'} />
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={{ padding: 12 }}>
            <Card style={{ padding: 12 }}>
              ...
              {detailsView.item.status === 'disapproved' ?
            ...
            {showmodal ? (
              <>
                <Snackbar
                  ...
                  Appication Approved successfully!
                </Snackbar>
              </>
            ) : null}
          </View>
...
export default DisapprovedDetails;
