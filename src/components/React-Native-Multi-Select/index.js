...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    styleDropdownMenu: PropTypes.object,
    styleDropdownMenuSubsection: PropTypes.object,
    styleInputGroup: PropTypes.object,
    styleItemsContainer: PropTypes.object,
    styleListContainer: PropTypes.object,
    styleMainWrapper: PropTypes.object,
    styleRowList: PropTypes.object,
    styleSelectorContainer: PropTypes.object,
    styleTextDropdown: PropTypes.object,
    styleTextDropdownSelected: PropTypes.object,
    styleTextTag: PropTypes.object,
          ...
          >
            ...
            >
              <TextInput
                ...
                style={[searchInputStyle, { flex: 1, backgroundColor: '#fff' }]}
                theme={{
                  colors: {
                    text: 'black',
                  },
