...
export const LocationList = (props) => {
  ...
  const handleSubmit = async () => {
    ...
    console.log(value);
    console.log('ppppp', props.route.params.symptomid);
    let arr = [];
    arr = [...value, ...props.route.params.symptomid];
    console.log(arr);
    props.navigation.navigate('WornsedList', {
      symptomid: arr,
      symptomid1: props.route.params.symptomid,
      symptomid2: value,
        ...
        >
          <TouchableOpacity onPress={() => props.navigation.goBack(null)}>
            <Image
              ...
              resizeMode="contain"
              style={{ width: 20, height: 20, marginTop: 55 }}
            />
          </TouchableOpacity>
          <Text
            style={{
          ...
          >
            Please select the{'\n'}{' '}
            <Text style={{ color: 'green', fontWeight: 'bold' }}>Location</Text>{' '}
            of {'\n'} pain 🙆🏽‍♂️ 🥵
          </Text>
          <Animated.View
            style={[
          ...
          >
            <Image
              ...
              source={{
                uri: 'https://www.healthwithhomeo.com/images/resource/Musculoskeletal.gif',
              }}
            />
          </Animated.View>
        </View>
