...
export const WornsedList = (props) => {
  ...
  const handleSubmit = async () => {
    ...
    console.log(arr);
    console.log('mail===', props.route.params.mail);
    props.navigation.navigate('ImproveList', {
      symptomid: arr,
        ...
        >
          <TouchableOpacity onPress={() => props.navigation.goBack(null)}>
            <Image
              ...
              resizeMode="contain"
              style={{ width: 20, height: 20, marginTop: 25, marginRight: 20 }}
            />
          </TouchableOpacity>
          <Text
            style={{
          ...
          >
            <Image
              ...
              source={{
                uri: 'https://media.tenor.com/fZzcWofc3aoAAAAC/thumbs-down-emoji.gif',
              }}
            />
          </Animated.View>
        </View>
