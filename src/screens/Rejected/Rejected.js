...
export const Rejected = (props) => {
  ...
  const data = [
    {
      id: 1,
      img: require('../../Assets/subhasis.png'),
      title: 'Subhasis Pol',
    ...
    {
      id: 3,
      img: require('../../Assets/sumit.png'),
      title: 'Sumit Sen',
      description: 'Voice call',
      sch: '- Schedule ',
      image: require('../../Assets/voicecall.png'),
    },
    {
      id: 4,
      img: require('../../Assets/stive.png'),
      title: 'Pitar le',
      description: 'Video call',
      sch: '- Schedule ',
      image: require('../../Assets/videocall.png'),
