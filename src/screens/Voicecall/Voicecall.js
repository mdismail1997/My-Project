...
export const Voicecall = (props) => {
  ...
  useEffect(() => {
    setIntervalref.current = setInterval(() => {
      ...
      if (
        Date.now() > props.route.params?.endtime - 60000 &&
        Date.now() <= props.route.params?.endtime &&
        !modalClosed
      ) {
        SetIsModal(false);
      ...
      {(status === 'connected' || status === 'connecting') && (
        <View style={styles.callContainer}>
            ...
            <View style={{ flex: 1 }}>
              ...
              {userRole === 'Doctor' ? (
                <View style={{ alignSelf: 'center', marginTop: 50 }}>
                  ...
                  >
                    {' '}
                    {props.route.params?.pname}{' '}
                  </Text>
                  <Ionicons
                    name="call"
                    size={26}
                    style={{ color: 'grey', alignSelf: 'center', marginTop: 10 }}
                  />
                </View>
              ) : (
                <View style={{ alignSelf: 'center', marginTop: 50 }}>
                  ...
                  >
                    {' '}
                    {props.route.params?.dname}{' '}
                  </Text>
                  <Ionicons
                    name="call"
                    size={26}
                    style={{
                      color: 'grey', alignSelf: 'center', marginTop: 10
                    }}
                  />
                </View>
              )}
          ...
          <View style={styles.optionsContainer}>
            ...
            >
              <Octicons name="issue-reopened" size={30} />
            </TouchableOpacity> */}
            {userRole === 'Doctor' ? (
              <TouchableOpacity
                style={styles.optionButton}
...
*/}
            ...
            >
              {getmedicalhistory.map((el) => (
                <List.Item
                  title={el}
                  titleStyle={{ marginBottom: 20, color: '#000' }}
                />
              ))}
            </List.Accordion>
            <List.Accordion
